...
import static concurency_threads.thread.ThreadColor.*;
...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        //anonimuos class it's useful if you want to run code once because is easier to configure
        new Thread() {
            public void run() {
        ...
        new Thread(new MyRunnable() {
            ...
            public void run() {
                ...
                try {
                    ...
                    System.out.println(ANSI_RED + "Another thread terminated,or timeout, so i'm running again");
