package util.concurent.concurent_interfaces.BlockingQueue.BlockingQueue_is_Implemented_by.ArrayBlockingQueue.WW_Doc;
...
/*                        ArrayBlockingQueue
    ...
    ArrayBlockingQueue and LinkedBlockingQueue in Java Collection are the common implementations of the BlockingQueue
        ...
        • ArrayBlockingQueue:
             ArrayBlockingQueue class and its iterator implement all the optional methods of the Collection and Iterator
                 interfaces.
       ...
       LinkedBlockingQueue:
         • LinkedBlockingQueue is an optionally-bounded BlockingQueue --backed by linked nodes. Here, optionally-bounded
             ...
             implement all the optional methods of the Collection and Iterator interfaces. LinkedBlockingQueue stores
