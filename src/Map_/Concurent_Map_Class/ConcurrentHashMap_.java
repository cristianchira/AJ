 ...
 */
public class ConcurrentHashMap_<K,V> extends AbstractMap<K,V>
     ...
     */
    public ConcurrentHashMap_(int initialCapacity) {
     ...
     * @param m the map
     */
    public ConcurrentHashMap_(Map<? extends K, ? extends V> m) {
     ...
     * @since 1.6
     */
    public ConcurrentHashMap_(int initialCapacity, float loadFactor) {
    ...
    public static <K> KeySetView<K,Boolean> newKeySet() {
        return new KeySetView<K,Boolean>
            (new ConcurrentHashMap_<K,Boolean> (), Boolean.TRUE);
    }
    ...
    public static <K> KeySetView<K,Boolean> newKeySet(int initialCapacity) {
        return new KeySetView<K,Boolean>
            (new ConcurrentHashMap_<K,Boolean> (initialCapacity), Boolean.TRUE);
    }
...
//    }
    ...
    static class BaseIterator<K,V> extends Traverser<K,V> {
        final ConcurrentHashMap_<K,V> map;
        Node<K,V> lastReturned;
        BaseIterator(Node<K,V>[] tab, int size, int index, int limit,
                    ConcurrentHashMap_<K,V> map) {
    ...
    static final class MapEntry<K,V> implements Entry<K,V> {
        ...
        V val;       // non-null
        final ConcurrentHashMap_<K,V> map;
        MapEntry(K key, V val, ConcurrentHashMap_<K,V> map) {
            this.key = key;
            this.val = val;
            this.map = map;
        }
    ...
    static final class EntrySpliterator<K,V> extends Traverser<K,V>
        ...
        final ConcurrentHashMap_<K,V> map; // To export MapEntry
        long est;               // size estimate
        EntrySpliterator(Node<K,V>[] tab, int size, int index, int limit,
                         long est, ConcurrentHashMap_<K,V> map) {
            super(tab, size, index, limit);
            this.map = map;
            this.est = est;
        }
    ...
    abstract static class CollectionView<K,V,E>
        ...
        private static final long serialVersionUID = 7249069246763182397L;
        final ConcurrentHashMap_<K,V> map;
        CollectionView(ConcurrentHashMap_<K,V> map)  { this.map = map; }
         ...
         */
        public ConcurrentHashMap_<K,V> getMap() { return map; }
    ...
    public static class KeySetView<K,V> extends CollectionView<K,V,K>
        ...
        KeySetView(ConcurrentHashMap_<K,V> map, V value) {  // non-public
            super(map);
            this.value = value;
        }
    ...
    static final class ValuesView<K,V> extends CollectionView<K,V,V>
        ...
        private static final long serialVersionUID = 2249069246763182397L;
        ValuesView(ConcurrentHashMap_<K,V> map) { super(map); }
    ...
    static final class EntrySetView<K,V> extends CollectionView<K,V, Entry<K,V>>
        ...
        private static final long serialVersionUID = 2249069246763182397L;
        EntrySetView(ConcurrentHashMap_<K,V> map) { super(map); }
    ...
    static {
        try {
            U = sun.misc.Unsafe.getUnsafe();
            Class<?> k = ConcurrentHashMap_.class;
