...
package Map_.Concurent_Map_Class;
 ...
 * @since 1.6
 */
public class ConcurrentSkipListMap_<K,V> extends AbstractMap<K,V>
...
//        }
     ...
     */
    public ConcurrentSkipListMap_(Comparator<? super K> comparator) {
     ...
     *         or values are null
     */
    public ConcurrentSkipListMap_(Map<? extends K, ? extends V> m) {
        this.comparator = null;
        initialize();
        putAll(m);
    }
     ...
     */
    public ConcurrentSkipListMap_(SortedMap<K, ? extends V> m) {
     ...
     */
    public ConcurrentSkipListMap_<K,V> clone() {
        try {
            @SuppressWarnings("unchecked")
            ConcurrentSkipListMap_<K,V> clone =
                (ConcurrentSkipListMap_<K,V>) super.clone();
            clone.initialize();
    ...
    abstract class Iter<T> implements Iterator<T> {
        ...
        public void remove() {
            ...
            ConcurrentSkipListMap_.this.remove(l.key);
            lastReturned = null;
        }
    ...
    static final class KeySet<E>
        ...
        public Iterator<E> iterator() {
            if (m instanceof ConcurrentSkipListMap_)
                return ((ConcurrentSkipListMap_<E,Object>)m).keyIterator();
            else
        ...
        public Spliterator<E> spliterator() {
            if (m instanceof ConcurrentSkipListMap_)
                return ((ConcurrentSkipListMap_<E,?>)m).keySpliterator();
            else
    ...
    static final class Values<E> extends AbstractCollection<E> {
        ...
        public Iterator<E> iterator() {
            if (m instanceof ConcurrentSkipListMap_)
                return ((ConcurrentSkipListMap_<?,E>)m).valueIterator();
            else
        ...
        public Spliterator<E> spliterator() {
            if (m instanceof ConcurrentSkipListMap_)
                return ((ConcurrentSkipListMap_<?,E>)m).valueSpliterator();
            else
    ...
    static final class EntrySet<K1,V1> extends AbstractSet<Entry<K1,V1>> {
        ...
        public Iterator<Entry<K1,V1>> iterator() {
            if (m instanceof ConcurrentSkipListMap_)
                return ((ConcurrentSkipListMap_<K1,V1>)m).entryIterator();
            else
        ...
        public Spliterator<Entry<K1,V1>> spliterator() {
            if (m instanceof ConcurrentSkipListMap_)
                return ((ConcurrentSkipListMap_<K1,V1>)m).entrySpliterator();
            else
    ...
    /**
     * Submaps returned by {@link ConcurrentSkipListMap_} submap operations
    ...
    static final class SubMap<K,V> extends AbstractMap<K,V>
        ...
        /** Underlying map */
        private final ConcurrentSkipListMap_<K,V> m;
         ...
         */
        SubMap(ConcurrentSkipListMap_<K,V> map,
    ...
    static {
        try {
            UNSAFE = sun.misc.Unsafe.getUnsafe();
            Class<?> k = ConcurrentSkipListMap_.class;
