 ...
 * {@link HashMap_} (which uses <i>chaining</i> rather than linear-probing).
 *
...
public class IdentityHashMap_<K,V>
    ...
    implements Map<K,V>, java.io.Serializable, Cloneable
{
     ...
     */
    public IdentityHashMap_(int expectedMaxSize) {
     ...
     */
    public IdentityHashMap_(Map<? extends K, ? extends V> m) {
    ...
    public boolean equals(Object o) {
        if (o == this) {
            return true;
        } else if (o instanceof IdentityHashMap_) {
            IdentityHashMap_<?,?> m = (IdentityHashMap_<?,?>) o;
            if (m.size() != size)
                return false;
    ...
    public Object clone() {
        try {
            IdentityHashMap_<?,?> m = (IdentityHashMap_<?,?>) super.clone();
            m.entrySet = null;
            m.table = table.clone();
            return m;
    ...
    private abstract class IdentityHashMapIterator<T> implements Iterator<T> {
        ...
        public void remove() {
            ...
            if (tab != IdentityHashMap_.this.table) {
                IdentityHashMap_.this.remove(key);
                expectedModCount = modCount;
                return;
            }
            ...
            for (int i = nextKeyIndex(d, len); (item = tab[i]) != null;
                ...
                if ((i < r && (r <= d || d <= i)) ||
                    ...
                    if (i < deletedSlot && d >= deletedSlot &&
                        traversalTable == IdentityHashMap_.this.table) {
        ...
        extends IdentityHashMapIterator<Entry<K,V>>
    {
        ...
        private class Entry implements Map.Entry<K,V> {
            ...
            public V setValue(V value) {
                ...
                if (traversalTable != IdentityHashMap_.this.table)
    ...
    private class KeySet extends AbstractSet<K> {
        ...
        public boolean remove(Object o) {
            int oldSize = size;
            IdentityHashMap_.this.remove(o);
            return size != oldSize;
        }
        /*
        ...
        public Spliterator<K> spliterator() {
            return new KeySpliterator<>(IdentityHashMap_.this, 0, -1, 0, 0);
        }
    }
    ...
    private class Values extends AbstractCollection<V> {
        ...
        public Spliterator<V> spliterator() {
            return new ValueSpliterator<>(IdentityHashMap_.this, 0, -1, 0, 0);
        }
    }
    ...
    private class EntrySet extends AbstractSet<Entry<K,V>> {
        ...
        public Spliterator<Entry<K,V>> spliterator() {
            return new EntrySpliterator<>(IdentityHashMap_.this, 0, -1, 0, 0);
        }
    }
    ...
    static class IdentityHashMapSpliterator<K,V> {
        final IdentityHashMap_<K,V> map;
        int index;             // current index, modified on advance/split
        int fence;             // -1 until first use; then one past last index
        int est;               // size estimate
        int expectedModCount;  // initialized when fence set

        IdentityHashMapSpliterator(IdentityHashMap_<K,V> map, int origin,
    ...
    static final class KeySpliterator<K,V>
        ...
        KeySpliterator(IdentityHashMap_<K,V> map, int origin, int fence, int est,
        ...
        public void forEachRemaining(Consumer<? super K> action) {
            ...
            IdentityHashMap_<K,V> m; Object[] a;
    ...
    static final class ValueSpliterator<K,V>
        ...
        ValueSpliterator(IdentityHashMap_<K,V> m, int origin, int fence, int est,
                         int expectedModCount) {
    ...
    static final class EntrySpliterator<K,V>
        ...
        EntrySpliterator(IdentityHashMap_<K,V> m, int origin, int fence, int est,
                         int expectedModCount) {
            super(m, origin, fence, est, expectedModCount);
        }
