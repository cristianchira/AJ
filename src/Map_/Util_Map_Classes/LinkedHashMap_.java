 ...
 * chaotic ordering provided by {@link HashMap_} (and {@link Hashtable_}),
 * without incurring the increased cost associated with {@link TreeMap_}.  It
    ...
    implements Map<K,V>
{
     ...
     */
    public LinkedHashMap_(Map<? extends K, ? extends V> m) {
        super();
        accessOrder = false;
