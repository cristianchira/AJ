 ...
 *
 * <p>Enum maps are maintained in the <i>natural order</i> of their keys (the order in which the enum constants are declared).
 * This is reflected in the iterators returned by the collections views ({@link #keySet()}, {@link #entrySet()}, and {@link #values()}).
 *
 ...
 * @since 1.5
 */
public class EnumMap_<K extends Enum<K>, V> extends AbstractMap_<K, V>
    implements java.io.Serializable, Cloneable
{
     ...
     */
    public EnumMap_(EnumMap_<K, ? extends V> m) {
        keyType = m.keyType;
     ...
     * identically to {@link #EnumMap_(EnumMap_)}.  Otherwise, the specified map
     ...
     * @throws NullPointerException if <tt>m</tt> is null
     */
    public EnumMap_(Map<K, ? extends V> m) {
        if (m instanceof EnumMap_) {
            EnumMap_<K, ? extends V> em = (EnumMap_<K, ? extends V>) m;
            keyType = em.keyType;
    ...
    public boolean equals(Object o) {
        if (this == o)
            return true;
        if (o instanceof EnumMap_)
            return equals((EnumMap_<?,?>)o);
        if (!(o instanceof Map))
            return false;
    ...
    private boolean equals(EnumMap_<?,?> em) {
        if (em.keyType != keyType)
    ...
    public EnumMap_<K, V> clone() {
        EnumMap_<K, V> result = null;
        try {
            result = (EnumMap_<K, V>) super.clone();
