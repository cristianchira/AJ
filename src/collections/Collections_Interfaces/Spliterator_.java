 ...
 * computation.  For example, a Spliterator for a {@link Collection_} would
 * report {@code SIZED}, a Spliterator for a {@link Set_} would report
 * {@code DISTINCT}, and a Spliterator for a {@link SortedSet_} would also
 ...
 * {@link OfInt int}, {OfLong long}, and { OfDouble double} values.
 * The subtype default implementations of
 * {@link Spliterator_#tryAdvance(Consumer)}
 * and {@link Spliterator_#forEachRemaining(Consumer)} box
 ...
 * @since 1.8
 */
public interface Spliterator_<T> {
    /**
    ...
    /**
     * If this Spliterator's source is {@link #SORTED} by a {@link Comparator_},
     ...
     */
    default Comparator_<? super T> getComparator() {
     ...
     * any {@link List_}. But no order is guaranteed for hash-based collections
     ...
     * applies for example, to a Spliterator based on a {@link Set_}.
     */
     ...
     * implement {@link NavigableSet_} or {@link SortedSet_} report {@code SORTED}.
     */
...
//        }
         ...
         * {tryAdvance(DoubleConsumer)}; otherwise
