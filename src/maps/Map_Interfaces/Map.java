 ...
 * @see Hashtable
 * @see SortedMap
 * @see collections.Collections_Interfaces.Collection
 * @see collections.Collections_Interfaces.Set
 * @since 1.2
 */
public interface Map<K,V> {
     ...
     * will probably require time linear in the map size for most implementations of the  Map interface.
     *
     * @param value value whose presence in this map is to be tested
     * @return true if this map maps one or more keys to the specified value
     * @throws ClassCastException if the value is of an inappropriate type forthis map
     * (<a href="{@docRoot}/java/util/Collection.html#optional-restrictions">optional</a>)
    ...
    /**
     * Returns the value to which the specified key is mapped, nullif this map contains no mapping for the key.
     *
     ...
     *
     * <p>Returns the value to which this map previously associated the key,or null if the map contained no mapping for the key.
     *
     * <p>If this map permits null values, then a return value of
     ...
     * iteration are undefined.  The collection supports element removal, which removes the corresponding
    ...
    interface Entry<K,V> {
         ...
         * @since 1.8
         */
        public static <K extends Comparable<? super K>, V> collections.Collections_Interfaces.Comparator<Entry<K,V>> comparingByKey() {
            return (collections.Collections_Interfaces.Comparator<Entry<K, V>> & Serializable)
         ...
         * @since 1.8
         */
        public static <K, V extends Comparable<? super V>> collections.Collections_Interfaces.Comparator<Entry<K,V>> comparingByValue() {
            return (collections.Collections_Interfaces.Comparator<Entry<K, V>> & Serializable)
         ...
         * {@link collections.Collections_Interfaces.Comparator}.
         *
         ...
         * @param  <K> the type of the map keys
         * @param  <V> the type of the map values
         * @param  cmp the key {@link collections.Collections_Interfaces.Comparator}
         * @return a comparator that compares {@link Entry} by the key.
         * @since 1.8
         */
        public static <K, V> collections.Collections_Interfaces.Comparator<Entry<K, V>> comparingByKey(collections.Collections_Interfaces.Comparator<? super K> cmp) {
         ...
         * @param  <K> the type of the map keys
         * @param  <V> the type of the map values
         * @param  cmp the value {@link collections.Collections_Interfaces.Comparator}
