...
import collections.Collections_Interfaces.Collection_;
import collections.Collections_Interfaces.Comparator_;
import collections.Collections_Interfaces.Set_;
 ...
 * have no effect on the map.  For example, invoking the {@link #putAll(Map_)}
...
public interface Map_<K,V> {
    ...
    interface Entry<K,V> {
         ...
         * @since 1.8
         */
        public static <K extends Comparable<? super K>, V> Comparator_<Entry<K,V>> comparingByKey() {
            return (Comparator_<Entry<K, V>> & Serializable)
         ...
         * @since 1.8
         */
        public static <K, V extends Comparable<? super V>> Comparator_<Entry<K,V>> comparingByValue() {
            return (Comparator_<Entry<K, V>> & Serializable)
         ...
         * @param  <K> the type of the map keys
         * @param  <V> the type of the map values
         * @param  cmp the key {@link Comparator_}
         * @return a comparator that compares {@link Entry} by the key.
         * @since 1.8
         */
        public static <K, V> Comparator_<Entry<K, V>> comparingByKey(Comparator_<? super K> cmp) {
         ...
         * @param  <K> the type of the map keys
         * @param  <V> the type of the map values
         * @param  cmp the value {@link Comparator_}
