 ...
 * as {@link Stream_#count()} or {@link Stream_#forEach(Consumer)}).
...
public interface Stream_<T> extends BaseStream<T, Stream_<T>> {
     ...
     */
    Stream_<T> filter(Predicate<? super T> predicate);
     ...
     * @return the new stream
     */
    <R> Stream_<R> map(Function<? super T, ? extends R> mapper);
     ...
     * @return the new stream
     */
    <R> Stream_<R> flatMap(Function<? super T, ? extends Stream_<? extends R>> mapper);
     ...
     * @return the new stream
     */
    Stream_<T> sorted(Comparator<? super T> comparator);
     ...
     * @return the new stream
     */
    Stream_<T> peek(Consumer<? super T> action);
...
//    }
     ...
     */
//    public static<T> Stream_<T> of(T t) {
...
//    public static<T> Stream_<T> of(T... values) {
...
//    }
     ...
     */
//    public static<T> Stream_<T> generate(Supplier<T> s) {
