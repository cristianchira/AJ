...
package Collections_.Collections_Interfaces.Set_.Set_Implemented_By.ConcurrentSkipListSet.WW_Doc;

import Map_.Concurent_Map_Class.ConcurrentSkipListMap_;
 ...
 * @since 1.6
 */
public class ConcurrentSkipListSet_<E>
    ...
    public ConcurrentSkipListSet_() {
        m = new ConcurrentSkipListMap_<E,Object> ();
    }
    ...
    public ConcurrentSkipListSet_(Comparator<? super E> comparator) {
        m = new ConcurrentSkipListMap_<E,Object> (comparator);
    }
    ...
    public ConcurrentSkipListSet_(SortedSet<E> s) {
        m = new ConcurrentSkipListMap_<E,Object> (s.comparator());
        addAll(s);
    }
    ...
    public ConcurrentSkipListSet_<E> clone() {
        try {
            ...
            clone.setMap(new ConcurrentSkipListMap_<E,Object> (m));
            return clone;
...
//        else
//            return (Spliterator<E>)((ConcurrentSkipListMap_.SubMap<E,?>)m).keyIterator();
//    }
    ...
    static {
        try {
            ...
            Class<?> k = ConcurrentSkipListSet_.class;
