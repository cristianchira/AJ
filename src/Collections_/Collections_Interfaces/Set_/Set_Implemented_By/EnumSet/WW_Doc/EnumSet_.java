...
package Collections_.Collections_Interfaces.Set_.Set_Implemented_By.EnumSet.WW_Doc;
 ...
 * the set should be "wrapped" using the {@lin Collections#synchronizedSet}
 ...
 * @serial exclude
 */
public abstract class EnumSet_<E extends Enum<E>> extends AbstractSet<E>
...
//    }
     ...
     * factory method behaves identically to {@link #copyOf(EnumSet_)}.
