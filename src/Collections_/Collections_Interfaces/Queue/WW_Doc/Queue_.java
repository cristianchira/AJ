...
package Collections_.Collections_Interfaces.Queue.WW_Doc;
...
/**
 * A collection designed for holding elements prior to processing.Besides basic {@link Collection_ Collection} operations,
 ...
 * the other returns a special value (either {@code null} or {@code false}, depending on theoperation).The latter form of
 * the insert operation is designed specifically for use with capacity-restricted {@code Queue}implementations; in most
 ...
 * Collection_#add Collection.add} method, which can fail to
 ...
 */
public interface Queue_<E> extends Collection_<E> {
    /**
