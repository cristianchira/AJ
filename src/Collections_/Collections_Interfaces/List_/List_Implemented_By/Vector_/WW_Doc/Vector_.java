...
package Collections_.Collections_Interfaces.List_.List_Implemented_By.Vector_.WW_Doc;
 ...
 * ArrayList_} in place of {@code Vector}.
 *
 * @author  Lee Boynton
    ...
    implements List<E>, RandomAccess, Cloneable, java.io.Serializable
{
    ...
    public synchronized Object clone() {
        try {
            ...
            Vector_<E> v = (Vector_<E>) super.clone();
...
//    }
    ...
    private class Itr implements Iterator<E> {
        ...
        @SuppressWarnings("unchecked")
                final E[] elementData = (E[]) Vector_.this.elementData;
    ...
    static final class VectorSpliterator<E> implements Spliterator<E> {
        ...
        VectorSpliterator(Vector_<E> list, Object[] array, int origin, int fence,
