...
package Collections_.Collections_Interfaces.List_.List_Implemented_By.CopyOnWriteArrayList_;
...
public class CopyOnWriteArrayList_<E>
    ...
    {
        private final CopyOnWriteArrayList_<E> l;
        private final int offset;
        private int size;
        private Object[] expectedArray;

        // only call this holding l's lock
        COWSubList(CopyOnWriteArrayList_<E> list,
    ...
    static {
        try {
            ...
            Class<?> k = CopyOnWriteArrayList_.class;
