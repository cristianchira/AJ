package Collections_.miscelanous.Interfaces.List_Interface;
...
//        System.out.println("\n==============> 3. Iterator Example...");
//        Iterator<String> crunchifyIterator = crucifyList.iterator();
...
//        ListIterator<String> crunchifyListIterator = crucifyList.listIterator();
...
//        List<String> rl = new ArrayList<>(crucifyList);
//        printList(rl);
...
//          printList(crucifyList);
//          Collections.rotate(crucifyList, 1);
//          printList(crucifyList);

        //public static <T> boolean replaceAll---------------------------------------------------------------------------

//        printList(crucifyList);
//        boolean replaced = Collections.replaceAll(crucifyList, "Paypal", "SpaceX");
//        if (replaced) {
...
//         Collections.fill(crucifyList, "ZUZA");
//          printList(crucifyList);
