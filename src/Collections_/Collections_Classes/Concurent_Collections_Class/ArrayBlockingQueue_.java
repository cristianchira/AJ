 ...
 */
public class ArrayBlockingQueue_<E> extends AbstractQueue<E>
     ...
     */
    public ArrayBlockingQueue_(int capacity) {
        this(capacity, false);
    }
     ...
     * @throws IllegalArgumentException if {@code capacity < 1}
     */
    public ArrayBlockingQueue_(int capacity, boolean fair) {
        if (capacity <= 0)
    ...
    private class Itr implements Iterator<E> {
        ...
        Itr() {
            ...
            lastRet = NONE;
            final ReentrantLock lock = ArrayBlockingQueue_.this.lock;
            lock.lock();
            try {
                if (count == 0) {
                    // assert itrs == null;
                    ...
                    final int takeIndex = ArrayBlockingQueue_.this.takeIndex;
