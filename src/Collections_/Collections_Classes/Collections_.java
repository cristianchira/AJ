...
import Collections_.Collections_Interfaces.Set_.Set_Implemented_By.TreeSet.WW_Doc.TreeSet_;
...
public class Collections_ {
     ...
     *mutually comparable (that is, {@code e1.compareTo(e2)}  must not throw a {@code ClassCastException} for any elements
     ...
     *
     * @implNote
     * This implementation defers to the {@link List#sort(Comparator)} method using the specified list and a {@code null} comparator.
     *
    ...
    public static <T> int binarySearch(List<? extends T> list, T key, Comparator<? super T> c) {
        ...
        if (list instanceof RandomAccess || list.size()<BINARYSEARCH_THRESHOLD)
            return Collections_.indexedBinarySearch(list, key, c);
        else
            return Collections_.iteratorBinarySearch(list, key, c);
    }
    ...
    static class UnmodifiableNavigableMap<K,V>
        ...
        public Entry<K, V> lowerEntry(K key) {
            ...
            return (null != lower)
                ? new Collections_.UnmodifiableMap.UnmodifiableEntrySet.UnmodifiableEntry<>(lower)
                : null;
        }
        ...
        public Entry<K, V> floorEntry(K key) {
            ...
            return (null != floor)
                ? new Collections_.UnmodifiableMap.UnmodifiableEntrySet.UnmodifiableEntry<>(floor)
                : null;
        }
        ...
        public Entry<K, V> ceilingEntry(K key) {
            ...
            return (null != ceiling)
                ? new Collections_.UnmodifiableMap.UnmodifiableEntrySet.UnmodifiableEntry<>(ceiling)
                : null;
        }
        ...
        public Entry<K, V> higherEntry(K key) {
            ...
            return (null != higher)
                ? new Collections_.UnmodifiableMap.UnmodifiableEntrySet.UnmodifiableEntry<>(higher)
                : null;
        }
        ...
        public Entry<K, V> firstEntry() {
            ...
            return (null != first)
                ? new Collections_.UnmodifiableMap.UnmodifiableEntrySet.UnmodifiableEntry<>(first)
                : null;
        }
        ...
        public Entry<K, V> lastEntry() {
            ...
            return (null != last)
                ? new Collections_.UnmodifiableMap.UnmodifiableEntrySet.UnmodifiableEntry<>(last)
                : null;
        }
...
/**
        ...
        implements Map<K,V>, Serializable
    {
        ...
        public void putAll(Map<? extends K, ? extends V> t) {
            ...
            List<Entry<K,V>> checked = new ArrayList_<> (entries.length);
    ...
    private static class SingletonMap<K,V>
        ...
        public Set<Entry<K,V>> entrySet() {
            if (entrySet==null)
                entrySet = Collections_.<Entry<K,V>>singleton(
    ...
    private static class ReverseComparator
        ...
        private Object readResolve() { return Collections_.reverseOrder(); }
     ...
     * @see ArrayList_
     */
    public static <T> ArrayList_<T> list(Enumeration<T> e) {
        ArrayList_<T> l = new ArrayList_<> ();
