package Java.Data_Structures_in_Java.Non_Primitive_DS.Linear.Static.Arrays_.ArrayListChallenge;
...
public class Main {
    ...
    private static void removeContact() {
        ...
        if (mobilePhone.removeContact(oldContact)) {
            System.out.println("Successfully removed contact " + oldContact.getName());
        } else {
            System.out.println("Error removing contact " + oldContact.getName());
        }
    }
    ...
    private static void queryContact() {
        ...
        if (searchedContact == null) {
            ...
            System.out.println(searchedContact.getName() + " is found!");
        }
    }
